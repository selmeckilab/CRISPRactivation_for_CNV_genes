...
#SBATCH --nodes=1
#SBATCH --job-name="assembleguides003"
#SBATCH --ntasks=1
...
cd /projects/standard/selmecki/pvzande/CRISPRa/Selmecki_Project_003
...
fastq_path=/projects/standard/selmecki/shared/disaster_recovery/Sequencing_Runs/UMGC20241127/Selmecki_Project_003/${name}
